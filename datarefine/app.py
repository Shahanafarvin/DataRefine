...
import pandas as pd
from scripts.handle_missing import MissingDataHandler
from scripts.handle_outliers import OutlierHandler
from scripts.normalize import DataNormalizer
from scripts.data_quality_assessment import DataQualityAssessment
...
logo_path = pkg_resources.resource_filename('DataRefine', 'drlogo.jpeg')
st.set_page_config(
